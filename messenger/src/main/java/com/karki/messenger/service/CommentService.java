...
import com.karki.messenger.model.Comment;
...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		ErrorMessage errorMessage = new ErrorMessage("Oops !!! It seems like I didn't find although ", 404,
				"http://nirozjungkarki.com");
